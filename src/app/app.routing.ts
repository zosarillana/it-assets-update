...
import { ErrorGuard } from './core/auth/guards/error.guard';
...
export const appRoutes: Route[] = [
    ...
    // Admin routes
    {
        path       : '',
        canActivate: [AuthGuard],
        canActivateChild: [AuthGuard, ErrorGuard],
        component  : LayoutComponent,
        resolve    : {
        ...
        children   : [
            ...
            //masterdata
            {path: 'masterdata', loadChildren: () => import('app/modules/admin/assets/assets-module/assets-module.module').then(m => m.AssetsModuleModule)}, 
            //users
            {path: 'users', loadChildren: () => import('app/modules/admin/users/users-module/users-module.module').then(m => m.UsersModuleModule)},                           
            //data
