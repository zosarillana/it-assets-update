            ...
            next: (data: any) => {
                        ...
                        accountability: {
                            ...
                            owner: {
                                ...
                                designation:
                                    ...
                                    'N/A',
                                company:
                                    data.accountability.owner?.company || 'N/A',
                                department:
                    ...
                    ? [
                          {
                              ...
                              status: 'Returned', // Default status since it's archived
                              remarks: data.computer.remarks || 'N/A',
                          },
                      ]
                    : [];
                ...
                this.components =
                    data.components?.map((component: any) => ({
                        ...
                        remarks: 'N/A', // No remarks in the response
                    })) || [];
