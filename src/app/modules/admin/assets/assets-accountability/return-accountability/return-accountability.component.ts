...
import { ReturnAccountabilityItemsService } from 'app/services/accountability/return-accountability-items.service';

@Component({
  selector: 'app-return-accountability',
  templateUrl: './return-accountability.component.html',
  styleUrls: ['./return-accountability.component.scss']
})
export class ReturnAccountabilityComponent implements OnInit {
  ...
  constructor(
    ...
    private returnItemService: ReturnAccountabilityItemsService
  ) { }
